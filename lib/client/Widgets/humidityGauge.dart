...
class Humiditygauge extends StatelessWidget {
  ...
  const Humiditygauge({super.key, required this.humidity,  required this.maximum, required this.intervel});
        ...
        RadialAxis(
          ...
          pointers: <GaugePointer>[
            ...
            RangePointer(
              ...
              color: _gethumidityColor(humidity).withOpacity(0.3),
              enableAnimation: true,
  ...
  Color _gethumidityColor(double temp) {
    if (temp < 30) return Colors.blue[700]!;
    if (temp < 70) return Colors.green[700]!;
    return Colors.red[700]!;
  }

  String _gethumidityStatus(double temp) {
